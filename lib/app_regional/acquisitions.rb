...
# whats going on here?
# In a method, "Ruby automatically returns the last bit of Ruby code"
# p 117 Ruby Wizardry: An Introduction to Programming for Kids (Google eBook)

# what these methods (except initialize) return can be called an associative array, a hashed array or a dictionary
